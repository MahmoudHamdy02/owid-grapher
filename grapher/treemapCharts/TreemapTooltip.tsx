...
import { TreemapChartManager } from "./TreemapChartConstants.js"
...
@observer
export class TreemapTooltip extends React.Component<TreemapTooltipProps> {
    @computed private get yColumnSlug(): string | undefined {
        return this.props.manager.yColumnSlug
    }
    ...
    @computed private get datum():
        ...
        | undefined {
        return this.mapTable.get(this.yColumnSlug).owidRows[0]
    }
    ...
    @computed private get sparklineManager(): LineChartManager {
        ...
        const unit = this.sparklineTable.get(this.yColumnSlug).shortUnit
        const yAxisUnit =
            typeof unit === "string"
        ...
        return {
            ...
            yColumnSlug: this.yColumnSlug,
            colorColumnSlug: this.props.manager.colorColumnSlug,
            ...
            yAxisConfig: {
                ...
                min: this.props.manager.yAxisConfig?.min ?? undefined,
                max: this.props.manager.yAxisConfig?.max ?? undefined,
                ticks: [
    ...
    render(): JSX.Element {
        ...
        const { isEntityClickable, targetTime } = this.props
